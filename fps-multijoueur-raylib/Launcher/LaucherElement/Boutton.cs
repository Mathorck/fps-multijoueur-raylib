...
public class Boutton
{
    ...
    public Boutton(Rectangle rectangle, string text, Color btnColor, Color fontColor, Color btnColorActive,
        Color fontColorActive, LauncherPage onClickPage)
    {
    ...
    public void Draw()
    {
        if (!isActive)
        {
            ...
            DrawText(text, (int)(rectangle.X + rectangle.Width / 2 - MeasureText(text, Launcher.FONT_SIZE) / 2),
                (int)(rectangle.Y + rectangle.Height / 2 - Launcher.FONT_SIZE / 2), Launcher.FONT_SIZE, fontColor);
        }
        else
        {
