...
namespace DeadOpsArcade3D.Launcher.LauncherElement
{
    ...
    public class ServerObject
    {
        ...
        /// </summary>
        private static int recWidth = Launcher.btnServerWidth;
        private static int recHeight = Launcher.btnServerHeight;
        private static int TopMenuHeight = Launcher.TopMenuHeight;
        private static int spaceBetweenServers = Launcher.spaceBetweenServer;
