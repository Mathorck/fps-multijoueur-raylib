...
namespace DeadOpsArcade3D.Launcher.LauncherElement
{
    ...
    public class InputButton
    {
        ...
        public InputButton(Rectangle rectangle, string text, int maxInputChar, Color backColor, Color fontColor, Color borderColor, Color backColorActive, Color fontColorActive, Color borderColorActive, bool isSecret)
        {
            ...
            this.btnColorActive = backColorActive;
        ...
        public void Draw()
        {
            ...
            {
                DrawButton();
                DrawText(inputText, (int)(rectangle.X + Launcher.FONT_SIZE), (int)(rectangle.Y + rectangle.Height / 2 - Launcher.FONT_SIZE / 2), Launcher.FONT_SIZE, isActive ? fontColorActive : fontColor);
            }
            else
            {
                DrawButton();
                string maskedInput = new string('*', inputText.Length);
                DrawText(maskedInput, (int)(rectangle.X + Launcher.FONT_SIZE), (int)(rectangle.Y + rectangle.Height / 2 - Launcher.FONT_SIZE / 2), Launcher.FONT_SIZE, isActive ? fontColorActive : fontColor);
            }
        ...
        private void DrawButton()
        {
            ...
            DrawText(text, (int)(rectangle.X - MeasureText(text, Launcher.FONT_SIZE) - Launcher.FONT_SIZE), (int)(rectangle.Y + rectangle.Height / 2 - Launcher.FONT_SIZE / 2), Launcher.FONT_SIZE, textColor);
        }
    }
}
